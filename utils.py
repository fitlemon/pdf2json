...
async def pdf2json_llm(text, item_type, llm):
    ...
    if item_type == "unknown_device":
        input_query = f"Тебе дан текст с техническими характеристиками изделия. Сформируй из него json file, максимально описывающий технические характеристики изделия."
